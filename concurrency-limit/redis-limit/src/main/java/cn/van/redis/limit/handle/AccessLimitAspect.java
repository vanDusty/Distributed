package cn.van.redis.limit.handle;

import cn.van.redis.limit.annotation.AccessLimit;
import cn.van.redis.limit.util.CacheCountUtil;
import cn.van.redis.limit.util.IpAddressUtil;
...
public class AccessLimitAspect {
     ...
     * 切入点
     */
    @Pointcut("@annotation(cn.van.redis.limit.annotation.AccessLimit)")
